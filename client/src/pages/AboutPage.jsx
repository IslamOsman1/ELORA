  ...
  return (
    <main>
      <PageHero
        ...
        image="https://images.unsplash.com/photo-1643297654416-057ab661f8f7?auto=format&fit=crop&w=1400&q=80"
      />

      <section className="px-4 py-20">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[.95fr_1.05fr]">
          <div className="premium-card overflow-hidden">
            <img src="https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?auto=format&fit=crop&w=1400&q=80" alt="ELORA clinic" className="h-[280px] w-full object-cover sm:h-[420px] lg:h-full" />
          </div>
          <div>
            <SectionHeading eyebrow="ELORA" title={t('about.storyTitle')} text={t('about.storyText')} align="start" />
